...
function getType (value: ArrayBuffer | ArrayBufferView) {
...
function getBuffer (value: ArrayBuffer | ArrayBufferView) {
...
export function isBuffer (value: ArrayBuffer | ArrayBufferView) {
...
export function bufferToMeta (value: ArrayBuffer | ArrayBufferView): BufferMeta {
  return {
    type: getType(value),
